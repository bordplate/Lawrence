local locationToActionMap = {
    -- novalis
    [1] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 2, 1, 1) end, -- Plumber
    [2] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 3, 1, 1) player:SetLevelFlags(1,1,0,{0xff}) universe.got_novalis_mayor = true end, -- Mayor
    ...
    -- Aridia
     [7] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x1e, 1, 1) end, -- Skid
     [8] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x1a, 1, 1) end, -- trespasser
     [9] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x5, 1, 1) end, -- Skids agent
    ...
    -- Kerwan
    [14] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0xc, 1, 1) end, -- Helga
    [15] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x2, 1, 1) player:SetLevelFlags(2, 3, 78, {1}) end, -- Al
    [16] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 4, 1, 1) end, -- Train infobot
    ...
    -- Eudora
    [21] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 6, 1, 1) player:SetLevelFlags(1, 4, 1, {0xff}) player:SetLevelFlags(2, 4, 16, {128}) player:SetLevelFlags(2, 4, 41, {16}) end, -- Henchman
    [22] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x9, 1, 1) end, -- suck cannon
    ...
    -- Rilgar
    [25] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 7, 1, 1) end, -- Bouncer
    [26] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x30, 1, 1) end, -- zoomerator
    [27] = function (universe, player) universe:RemoveVendorItem(0x11) end, -- mine glove
    [28] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x17, 1, 1) end, -- ryno
    ...
    -- Blarg
    [31] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x16, 1, 1) player:SetLevelFlags(1, 6, 1, {0xff}) end, -- Hydrodisplacer
    [32] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 5, 1, 1) player:SetLevelFlags(1, 6, 0, {0xff}) end, -- Explosion Infobot
    [33] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x1d, 1, 1) end, -- Scientist
    ...
    -- Umbris
    [37] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 8, 1, 1) end, -- infobot
    ...
    [41] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 9, 1, 1) end, -- deserter
    [42] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 10, 1, 1) end, -- commando
    ...
    [47] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x7, 1, 1) print("did the thing") end, -- pilot helmet
    ...
    [51] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 11, 1, 1) player:SetLevelFlags(2, 10, 30, {112}) player:SetLevelFlags(2, 10, 103, {1}) end, -- clank infobot
    [52] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 12, 1, 1) player:SetLevelFlags(1, 10, 4, {0xff}) player:SetLevelFlags(2, 87, 4, {2}) player:SetLevelFlags(2, 10, 102, {48}) end, -- ratchet infobot
    [53] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x1c, 1, 1) player:SetLevelFlags(1, 10, 1, {0xff}) player:SetLevelFlags(2, 10, 35, {2}) player:SetLevelFlags(1, 10, 1, {0xff}) end, -- magneboots
    [54] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x34, 1, 1) player:SetLevelFlags(2, 10, 31, {1}) player:SetLevelFlags(2, 10, 87, {2}) player:SetLevelFlags(1, 10, 0, {0xff}) end, -- premium nanotech
    [55] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x35, 1, 1) end, -- ultra nanotech
    ...
    [59] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x6, 1, 1) end, -- O2 mask
    [60] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x23, 1, 1) player:SetLevelFlags(1, 11, 4, {0xff}) end, -- persuader
    [61] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x3, 1, 1) end, -- thruster pack
    ...
    [64] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 13, 1, 1) end, -- infobot. do nothing
    [65] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x4, 1, 1) end, -- hydro pack
    [66] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x31, 1, 1) end, -- raritanium
    ...
    -- Gemlik
    [69] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 14, 1, 1) player:SetLevelFlags(2,13,113,{3}) end, -- qwark infobot
    ...
    [72] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 15, 1, 1) universe.got_oltanis_infobot = true player:SetLevelFlags(1, 14, 1, {0xff}) player:SetLevelFlags(1, 14, 7, {0xff}) player:SetLevelFlags(2, 14, 0, {2}) FixPlanetsForPlayer(universe, player) end, -- infobot
    [73] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x20, 1, 1) universe.got_oltanis_PDA = true player:SetLevelFlags(1, 14, 0, {0xff}) player:SetLevelFlags(1, 14, 11, {0xff}) player:SetLevelFlags(2, 14, 1, {16}) player:SetLevelFlags(2, 14, 46, {1}) player:SetLevelFlags(2, 14, 47, {8}) FixPlanetsForPlayer(universe, player) end, -- Steve
    [74] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x15, 1, 1) universe.got_oltanis_morph = true player:SetLevelFlags(1, 14, 2, {0xff}) player:SetLevelFlags(1, 14, 8, {0xff}) FixPlanetsForPlayer(universe, player) end, -- morph O ray
    ...
    -- Quartu
    [79] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 16, 1, 1) end, -- giant clank infobot. do nothing
    [80] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x22, 1, 1) end, -- bolt grabber
    [81] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 17, 1, 1) end, -- infiltrate infobot. do nothing
    ...
    -- Kalebo III
    [84] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x1f, 1, 1) end, -- hologuise. do nothing
    [85] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x21, 1, 1) end, -- helpdesk lady. do nothing
    ...
    -- Drek's Fleet
    [88] = function (universe, player) player:SetAddressValue(Player.offset.proxy_level_array + 18, 1, 1) player:SetLevelFlags(1, 17, 3, {0xff}) end, -- infobot
    [89] = function (universe, player) player:SetAddressValue(Player.offset.proxy_item_array + 0x32, 1, 1) end, -- codebot
