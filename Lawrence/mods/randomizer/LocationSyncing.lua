local locationToActionMap = {
    ...
    [95] = function (universe, player) universe.replacedMobys:GetMoby('BombGloveCase'):Disable() universe.used_gold_bolts = universe.used_gold_bolts + 4 end,
    [96] = function (universe, player) universe.replacedMobys:GetMoby('PyrocitorCase'):Disable() universe.used_gold_bolts = universe.used_gold_bolts + 4 end,
    [97] = function (universe, player) universe.replacedMobys:GetMoby('BlasterCase'):Disable() universe.used_gold_bolts = universe.used_gold_bolts + 4 end,
    [98] = function (universe, player) universe.replacedMobys:GetMoby('GloveOfDoomCase'):Disable() universe.used_gold_bolts = universe.used_gold_bolts + 4 end,
    [99] = function (universe, player) universe.replacedMobys:GetMoby('SuckCannonCase'):Disable() universe.used_gold_bolts = universe.used_gold_bolts + 4 end,
